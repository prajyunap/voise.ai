...
// Voice demo button functionality
document.getElementById('try-voice-btn').addEventListener('click', function() {
    const button = this;
    const originalText = button.innerHTML;
    
    // Change button state to "listening"
    button.innerHTML = '<span class="button-icon">🔴</span>Listening...';
    ...
    setTimeout(() => {
        ...
        setTimeout(() => {
            button.innerHTML = '<span class="button-icon">✨</span>Demo Complete!';
            button.style.background = 'linear-gradient(135deg, #48dbfb 0%, #0abde3 100%)';
