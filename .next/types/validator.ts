...
// Validate ../../app/api/calls/web/start/route.ts
{
  const handler = {} as typeof import("../../app/api/calls/web/start/route.js")
  handler satisfies RouteHandlerConfig<"/api/calls/web/start">
}

// Validate ../../app/api/knowledge/upload/route.ts
{
  const handler = {} as typeof import("../../app/api/knowledge/upload/route.js")
  handler satisfies RouteHandlerConfig<"/api/knowledge/upload">
}
